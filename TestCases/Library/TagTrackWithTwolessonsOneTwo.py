...
class TagTrackWithTwolessonsOneTwo():
    ...
    def tagTrackWithTwolessonsOneTwo(self):
        ...
        try:
            ...
            tr=TagTrackWithTwolessonsOneTwo()
            tr.createTrackwithTxtAndImgLesson(titleOfTrack, Imagefilepath, description, tagName, lessonNameforTextcard, lessonNameforImgcard, expectedSuccessText)
            tr1=TagPageElements()
