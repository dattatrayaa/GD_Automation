...
class TagTrackWiththreelessons_Five_Six_Seven():
    ...
    def tagtrackWithQuesAllCardOneAndTwoTimeLessons(self):
        ...
        cell = first_sheet.cell(14,4)
        ExpectedTrackMessage = cell.value
       
        cell = first_sheet.cell(14,5)
        ...
        try:
            ...
            tr=TagTrackWiththreelessons_Five_Six_Seven()
            
            tr.allCardsOneTime(lessonNameforAllCardOneTime, textCard, Imagefilepath1, videoPath, timeToUploadVideo, documentPath, timetoUploadDoc, questionCard, ans1, ans2)
            tr.allCardsTwoTime(lessonNameforAllCardTwoTime, textCard, Imagefilepath1, videoPath, timeToUploadVideo, documentPath, timetoUploadDoc, questionCard, ans1, ans2)
            tr.trackWithQueLessonAllCard1TimeAndTwoTime(titleOfTrack, Imagefilepath, description, tagName, lessonNameforQuescard, lessonNameforAllCardOneTime, lessonNameforAllCardTwoTime, expectedSuccessText)
            tr1=TagPageElements()
            tr1.tagCreation(TagName)
            tr1.addlesson(lessonNameforQuescard)
            tr1.addlesson(lessonNameforAllCardOneTime)
            tr1.addlesson(lessonNameforAllCardTwoTime)
            tr1.addTrack(titleOfTrack)  
            tr1.library(TagName)
            tr1.lessonLibrary(lessonNameforQuescard)
            tr1.lessonLibrary(lessonNameforAllCardOneTime)
            tr1.lessonLibrary(lessonNameforAllCardTwoTime)
  ...
  #  btc=BaseTestClass()
  #  btc.UserLogin()
   # m1=TagTrackWiththreelessons_Five_Six_Seven()
   # m1.tagtrackWithQuesAllCardOneAndTwoTimeLessons()
