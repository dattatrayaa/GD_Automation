...
class LibraryTrackWithfourlessonsTenTwelveThree():  
    ...
    def tagtrackWithfourlessonsTenTwelveThree(self):
        ...
        cell = first_sheet.cell(16,4)
        ExpectedTrackMessage = cell.value
       
        cell = first_sheet.cell(16,5)
        ...
        try:     
            ...
            tr11=LibraryTrackWithfourlessonsTenTwelveThree()
