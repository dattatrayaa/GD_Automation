...
class LibraryLessonImage():  
    def taglessonWithImageUploadCard(self):
        ...
        cell = first_sheet.cell(26,5)
        ExpectedAddLessonMessage = cell.value
        
        try:
            img=TagPageElements()
            im=CreateLessonDifferentLessons()
            im.lessonWithImage(lessonname, imagefilepath)
            driver.refresh()
  ...
  #  btc.UserLogin()
   ...
   # m2=TagImageLesson()
   # m2.taglessonWithImageUploadCard()
