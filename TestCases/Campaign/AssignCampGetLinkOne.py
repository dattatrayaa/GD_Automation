...
class AssignCampGetLinkOne:
    ...
    def getLinkOneMain(self):
        ...
        #Campaign
        cell1 = first_sheet.cell(747,1)
        campaignTitle = cell1.value
        
        cell1 = first_sheet.cell(748,1)
        campDescription = cell1.value
        
        
        cell1 = first_sheet.cell(749,1)
        lessonName = cell1.value
        
        
        
        cell2 = first_sheet.cell(750,1)
        questionCard= cell2.value
        
        cell2 = first_sheet.cell(751,1)
        ans1= cell2.value
        
        cell2 = first_sheet.cell(752,1)
        ans2= cell2.value
        ...
        cell = first_sheet.cell(758,1)
        Password = cell.value
        
        cell = first_sheet.cell(759,1)
        ...
        sheet.cell(row=755, column=2).value = FirstNameUpdated
        sheet.cell(row=756, column=2).value = LastNameUpdated
        sheet.cell(row=757, column=2).value = EmailIdUpdated
        sheet.cell(row=758, column=2).value = EmployeeIdUpdated
