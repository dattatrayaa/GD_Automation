...
class AssignCampCreatorToMA:
    
    def campCreatedByCreatorforMa(self,creatorEmail,creatorPassword,campaignTitle,campDescription,lessonName,nameOfMa,minPassingScore,numberOfAttempts):
        ...
        driver.find_element_by_xpath(".//*[@id='username']").send_keys(creatorEmail)
       
        print "Entering Password"
        element.send_keys(creatorPassword)
        ...
        elements.addingUser(nameOfMa)
        
        
        print "Verifying User is displayed in Grid"
        if nameOfMa in elements.userInGrid():
    ...
    def assignmentCheck(self,MAEmail,MAPassword,campaignTitle,lessonName,username,password):
        
        print "\nChecking sent assignment is displayed for Master administrator"
        wait=WebDriverWait(driver, 60)
        driver.refresh()
        wait.until(EC.visibility_of_element_located((By.XPATH,".//*[@id='content']/div/div[1]/div[1]/nav/div[2]/a/span[3]")))
        ...
        print "Entering User name"
        driver.find_element_by_xpath(".//*[@id='username']").send_keys(MAEmail)
       
        print "Entering Password"
        element.send_keys(MAPassword)
    ...
    def assignCampFromCreatorToMAAndCheckAssignDisplayed(self):
        ...
        #Campaign
        cell1 = first_sheet.cell(698,1)
        campaignTitle = cell1.value
        
        cell1 = first_sheet.cell(699,1)
        campDescription = cell1.value
        
        cell1 = first_sheet.cell(700,1)
        minPassingScore = cell1.value
        
        cell1 = first_sheet.cell(701,1)
        numberOfAttempts = cell1.value
        
        
        
        
        cell1 = first_sheet.cell(702,1)
        lessonName = cell1.value
        
        cell2 = first_sheet.cell(703,1)
        questionCard= cell2.value
        
        cell2 = first_sheet.cell(704,1)
        ans1= cell2.value
        
        cell2 = first_sheet.cell(705,1)
        ans2= cell2.value
        ...
        cell = first_sheet.cell(709,1)
        creatorEmail = cell.value
        
        EmailId = creatorEmail.split("_")
        emp = EmailId[0]+"_"
        ids = EmailId[1]
        ...
        cell = first_sheet.cell(711,1)
        Password = cell.value
        
        cell = first_sheet.cell(712,1)
        NewPassword = cell.value
        
        cell = first_sheet.cell(713,1)
        role1 = cell.value
        ...
        cell = first_sheet.cell(715,1)
        nameOfMa = cell.value
        
        FirstNameId1 = nameOfMa.split("_")
        emp = FirstNameId1[0]+"_"
        ids = FirstNameId1[1]
        empId = int(ids)+1
        FirstNameUpdated1= emp+str(empId)
        
        cell = first_sheet.cell(716,1)
        ...
        cell = first_sheet.cell(717,1)
        MAEmail = cell.value
        
        EmailId1 = MAEmail.split("_")
        emp = EmailId1[0]+"_"
        ids = EmailId1[1]
        remaining="_"+EmailId[2]
        empId = int(ids)+1
        ...
        sheet.cell(row=708, column=2).value = FirstNameUpdated
        sheet.cell(row=709, column=2).value = LastNameUpdated
        sheet.cell(row=710, column=2).value = EmailIdUpdated
        sheet.cell(row=711, column=2).value = EmployeeIdUpdated
        
        
        
        sheet.cell(row=716, column=2).value = FirstNameUpdated1
        sheet.cell(row=717, column=2).value = LastNameUpdated1
        sheet.cell(row=718, column=2).value = EmailIdUpdated1
        sheet.cell(row=719, column=2).value = EmployeeIdUpdated1
        ...
        try:
            ...
            lt.createUserWithRoleMain(FirstName, LastName, creatorEmail, EmployeeId, Password, role1, NewPassword, url, username, password)
            lt.createUserWithRoleMain(nameOfMa, LastName, MAEmail, EmployeeId, Password, role2, NewPassword, url, username, password)
            ...
            lk=AssignCampCreatorToMA()
            
            print "\nCreating Campaign\n"
            lk.campCreatedByCreatorforMa(creatorEmail, Password, campaignTitle, campDescription, lessonName, nameOfMa, minPassingScore, numberOfAttempts)
            
            
            
            print "\nChecking for master administrator assignment is displayed"
            lk.assignmentCheck(MAEmail, Password, campaignTitle, lessonName, username, password)
...
if __name__ == '__main__':
    ...
    hk=AssignCampCreatorToMA()
    hk.assignCampFromCreatorToMAAndCheckAssignDisplayed()
