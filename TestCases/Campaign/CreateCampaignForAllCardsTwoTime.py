...
class CreateCampaignForAllCardsTwoTime:
    ...
    def createCampaignWithAllCardsTwoTimeLesson(self):
        ...
        try:
            ...
            newobj.allCardstwoTime(lessonName, textCard, Imagefilepath1, videoPath, timeToUploadVideo, documentPath, timetoUploadDoc, questionCard, ans1, ans2)
...
if __name__ == '__main__':
    ...
    newObj=CreateCampaignForAllCardsTwoTime()
    newObj.createCampaignWithAllCardsTwoTimeLesson()        
