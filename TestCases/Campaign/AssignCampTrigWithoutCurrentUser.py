...
class AssignCampTrigWithoutCurrentUser:
    
    def campaignToGroupTriggeredWithoutuser(self,campaignTitle,campDescription,lessonName,groupName,minPassingScore,numberOfAttempts):
        ...
        searchGroups=wait.until(EC.visibility_of_element_located((By.XPATH,planAssign.AddGroupTextField()))) 
        ...
        yesSave=wait.until(EC.visibility_of_element_located((By.XPATH,planAssign.confirmPopupYesSaveButton())))
        yesSave.click()
    ...
    def assignmentCheck(self,EmailId,Password,campaignTitle,username,password):
        ...
        assignmentText=wait.until(EC.visibility_of_all_elements_located((By.XPATH,"//div[2]/div[1]/div/div/a[1]/span")))
        count= len(assignmentText)
        
        for count in range (0,count):
            
            real=assignmentText[count].text
            
            if campaignTitle in real:
                print "Campaign displayed for User in My learning page....which should not display"
                raise Exception
                
        print "Campaign not displayed for User.....functionality working as expected"
    ...
    def assignCampTOGroupWithoutCurrentUser(self):
        ...
        #Campaign
        cell1 = first_sheet.cell(256,1)
        campaignTitle = cell1.value
        
        cell1 = first_sheet.cell(257,1)
        campDescription = cell1.value
        
        cell1 = first_sheet.cell(273,1)
        ...
        cell1 = first_sheet.cell(258,1)
        minPassingScore = cell1.value
        
        cell1 = first_sheet.cell(259,1)
        numberOfAttempts = cell1.value
        
        cell1 = first_sheet.cell(260,1)
        ...
        cell = first_sheet.cell(269,1)
        Password = cell.value
        
        cell = first_sheet.cell(270,1)
        NewPassword = cell.value
        
        cell = first_sheet.cell(271,1)
        role = cell.value
        ...
        sheet.cell(row=266, column=2).value = FirstNameUpdated
        sheet.cell(row=267, column=2).value = LastNameUpdated
        sheet.cell(row=268, column=2).value = EmailIdUpdated
        sheet.cell(row=269, column=2).value = EmployeeIdUpdated
        
        sheet.cell(row=274, column=2).value = GroupNameUpdated
        ...
        try:
            ...
            print "\nCreating Group\n"
            lk=AssignCampTrigWithoutCurrentUser()
            ...
            print "\nCreating Campaign\n"
            lk.campaignToGroupTriggeredWithoutuser(campaignTitle, campDescription, lessonName, groupName, minPassingScore, numberOfAttempts)
            
            
            print "\nChecking for new user Assignment is sent and displayed in Home page"
            lk.assignmentCheck(Email, Password, campaignTitle, username, password)
            ...
            driver.save_screenshot("ScreenShots/AssignCampTrigWithoutCurrentUser.png")
...
if __name__ == '__main__':
    ...
    hk=AssignCampTrigWithoutCurrentUser()
    hk.assignCampTOGroupWithoutCurrentUser()
