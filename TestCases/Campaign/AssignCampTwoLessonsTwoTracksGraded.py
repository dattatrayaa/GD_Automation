...
class AssignCampTwoLessonsTwoTracksGraded:
    ...
    def assignCampWithTwoTrackTwoLessonGraded(self):
        ...
        try:
            ...
            driver.save_screenshot("ScreenShots/AssignCampTwoLessonsTwoTracksGraded.png") 
...
if __name__ == '__main__':
    ...
    ne=AssignCampTwoLessonsTwoTracksGraded()
    ne.assignCampWithTwoTrackTwoLessonGraded()
