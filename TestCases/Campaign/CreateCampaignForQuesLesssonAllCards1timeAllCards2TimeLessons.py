...
class CreateCampaignForQuesLesssonAllCards1timeAllCards2TimeLessons:
    ...
    def createCampaignWithThreeLessons(self):
        ...
        try:
            ...
            ui.lessonWithQuestion(lessonName1, questionCard, ans1, ans2)
            
            newobj=CreateCampaignForQuesLesssonAllCards1timeAllCards2TimeLessons()
            newobj.allCardsOneTime(lessonName2, textCard, Imagefilepath1, videoPath, timeToUploadVideo, documentPath, timetoUploadDoc, questionCard, ans1, ans2)
            newobj.allCardstwoTime(lessonName3, textCard, Imagefilepath1, videoPath, timeToUploadVideo, documentPath, timetoUploadDoc, questionCard, ans1, ans2)
...
if __name__ == '__main__':
    ...
    newObj=CreateCampaignForQuesLesssonAllCards1timeAllCards2TimeLessons()
    newObj.createCampaignWithThreeLessons()
