...
class AssignCampTenLessonsWithGraded:
    ...
    def assignCampWithTenLessonsGraded(self):
        ...
        try:
            ...
            driver.save_screenshot("ScreenShots/AssignCampTenLessonsWithGraded.png")
            ...
            try:
                oj=DeleteLesson()
                oj.lessonDelete(lessonName1)
                oj.lessonDelete(lessonName2)
                oj.lessonDelete(lessonName3)
                oj.lessonDelete(lessonName4)
                oj.lessonDelete(lessonName5)
                oj.lessonDelete(lessonName6)
                oj.lessonDelete(lessonName7)
                oj.lessonDelete(lessonName8)
                oj.lessonDelete(lessonName9)
                oj.lessonDelete(lessonName10) 
            except Exception:
                driver.get(url)    
