...
class LessonGetLinkDraftLearner:
    ...
    def LogoutAndcheckUnpublishedDraftLinkForLearner(self,Email,Password,lessonName,username,password):
        ...
        print "Checking lesson not displayed for learner"
        try:
            msg=wait.until(EC.visibility_of_element_located((By.XPATH, "//*[@id='content']/div/div/div/div[4]/div/div/div/div/h3")))
            print "Message '"+msg.text+"' is displayed for learner"
            print "Lesson not displayed for learner"
        except Exception:
            print "Lesson displayed for learner"
            raise Exception
    ...
    def LessonGetlinkUnpublishedDraftLearnerMain(self):
        ...
        try:
            ...
            un=LessonGetLinkDraftLearner()
            un.LessongetLink(lessonName, textCard, url)
            
            print "\nChecking for Learner Unpublished draft is displayeds\n"
            un.LogoutAndcheckUnpublishedDraftLinkForLearner(Email, Password, lessonName, username, password)
...
if __name__ == '__main__':
    ...
    les=LessonGetLinkDraftLearner()
    les.LessonGetlinkUnpublishedDraftLearnerMain()
