...
class LessonGetLinkBuilderToLearningAdmin:
    ...
    def LogoutAndcheckLesssonBuilderLinkForLearningAdmin(self,Email,lessonName,Password,username,password,textCard):
        ...
        print "Checking Lesson builder is displayed for Learning Admin"
        try:
            wait.until(EC.visibility_of_element_located((By.XPATH,"//textarea[contains(.,'"+lessonName+"')]")))
            print "Lesson '"+lessonName+"' is displayed in lesson builder"
        except Exception:
            print "Lesson builder is not displayed"
            raise Exception
        
        
        
        
        print "verifying Learning Admin is able to publish the lesson"
        print "Adding new card to lesson and publishing lesson"
        
        create=CreateLessonDifferentCards()
        create.textCard(textCard)
    ...
    def LessonGetlinkLessonBuilderForLearningAdminMain(self):
        ...
        cell1 = first_sheet.cell(75,5)
        lessonName = cell1.value
        
        cell2 = first_sheet.cell(76,5)
        textCard= cell2.value
        
        
        #Learner 1
        cell = first_sheet.cell(77,5)
        ...
        cell = first_sheet.cell(81,5)
        Password = cell.value
        
        cell = first_sheet.cell(81,5)
        NewPassword = cell.value
        
        cell = first_sheet.cell(74,5)
        role = cell.value
        ...
        sheet.cell(row=78, column=6).value = FirstNameUpdated
        sheet.cell(row=79, column=6).value = LastNameUpdated
        sheet.cell(row=80, column=6).value = EmailIdUpdated
        sheet.cell(row=81, column=6).value = EmployeeIdUpdated
        ...
        try:
            ...
            un=LessonGetLinkBuilderToLearningAdmin()
            un.LessongetLink(lessonName, textCard, url)
            print "\nChecking for LearningAdmin Lesson builder is displayed\n"
            un.LogoutAndcheckLesssonBuilderLinkForLearningAdmin(Email, lessonName, Password, username, password, textCard)
...
if __name__ == '__main__':
    ...
    les=LessonGetLinkBuilderToLearningAdmin()
    les.LessonGetlinkLessonBuilderForLearningAdminMain()
