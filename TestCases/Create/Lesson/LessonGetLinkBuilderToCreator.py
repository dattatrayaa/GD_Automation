...
class LessonGetLinkBuilderToCreator:
    ...
    def LogoutAndcheckLesssonBuilderLinkForCreator(self,Email,lessonName,Password,username,password,textCard):
        ...
        print "Checking for Creator Lesson builder is displayed"
        try:
        ...
        print "verifying Creator is able to publish the lesson"
    ...
    def LessonGetlinkLessonBuilderForCreatorMain(self):
        ...
        cell1 = first_sheet.cell(75,3)
        lessonName = cell1.value
        
        cell2 = first_sheet.cell(76,3)
        textCard= cell2.value
        
        
        #Learner 1
        cell = first_sheet.cell(77,3)
        ...
        cell = first_sheet.cell(81,3)
        Password = cell.value
        
        cell = first_sheet.cell(81,3)
        NewPassword = cell.value
        
        cell = first_sheet.cell(74,3)
        role = cell.value
        ...
        sheet.cell(row=78, column=4).value = FirstNameUpdated
        sheet.cell(row=79, column=4).value = LastNameUpdated
        sheet.cell(row=80, column=4).value = EmailIdUpdated
        sheet.cell(row=81, column=4).value = EmployeeIdUpdated
        ...
        try:
            ...
            un=LessonGetLinkBuilderToCreator()
            un.LessongetLink(lessonName, textCard, url)
            print "\nChecking for Creator Lesson builder is displayed\n"
            un.LogoutAndcheckLesssonBuilderLinkForCreator(Email, lessonName, Password, username, password, textCard)
...
if __name__ == '__main__':
    ...
    les=LessonGetLinkBuilderToCreator()
    les.LessonGetlinkLessonBuilderForCreatorMain()
