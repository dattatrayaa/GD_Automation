...
class TrackGetLinkBuilderTrackForLearner:
    ...
    def CheckForLearnerTrackDisplayed(self,Email,Password,username,password):
        ...
        print "Checking Validation message is displayed instead Track Builder"
        
        try:
            title=wait.until(EC.visibility_of_element_located((By.XPATH,"html/body/div[1]/div/div[3]/div[2]/div/div/h2")))
        except Exception:
            traceback.print_exc()
            raise Exception("Validation message is displayed")
        
        
        print "Validating Validation message displayed for learner"
        
        if title.text=="You are not authorized to edit this track.":
            print "Validation message '"+title.text+"' is displayed"
        else:
            print "Validation message not displayed"
            raise Exception("Validation message not displayed")
    ...
    def TrackGetLinkBuilderForLearnerMain(self):
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        first_sheet = book.sheet_by_name('TrackCreate')
        
        cell1 = first_sheet.cell(197,3)
        titleOfTrack = cell1.value
        
        cell2 = first_sheet.cell(198,3)
        Imagefilepath = cell2.value
        
        cell2 = first_sheet.cell(199,3)
        description = cell2.value
        
        cell2 = first_sheet.cell(200,3)
        tagName = cell2.value
        
        cell2 = first_sheet.cell(201,3)
        lessonName= cell2.value
        
        cell2 = first_sheet.cell(202,3)
        textCard= cell2.value
    
        cell2 = first_sheet.cell(203,3)
        expectedSuccessText= cell2.value
        
        
        
        cell = first_sheet.cell(204,3)
        ...
        sheet.cell(row=205, column=4).value = FirstNameUpdated
        sheet.cell(row=206, column=4).value = LastNameUpdated
        sheet.cell(row=207, column=4).value = EmailIdUpdated
        sheet.cell(row=208, column=4).value = EmployeeIdUpdated
        ...
        try:
            ...
            print "\nCreating Track"
            cr=TrackGetLinkBuilderTrackForLearner()
            ...
            cr.CheckForLearnerTrackDisplayed(Email, Password, username, password)
...
if __name__ == '__main__':
    ...
    tr=TrackGetLinkBuilderTrackForLearner()
    tr.TrackGetLinkBuilderForLearnerMain()
