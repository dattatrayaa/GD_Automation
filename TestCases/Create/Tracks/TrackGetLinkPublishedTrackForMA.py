...
class TrackGetLinkPublishedTrackForMA:
    ...
    def TrackGetLinkPublishedForMAMain(self):
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        first_sheet = book.sheet_by_name('TrackCreate')
        
        cell1 = first_sheet.cell(181,1)
        titleOfTrack = cell1.value
        
        cell2 = first_sheet.cell(182,1)
        Imagefilepath = cell2.value
        
        cell2 = first_sheet.cell(183,1)
        description = cell2.value
        
        cell2 = first_sheet.cell(184,1)
        tagName = cell2.value
        
        cell2 = first_sheet.cell(185,1)
        lessonName= cell2.value
        
        cell2 = first_sheet.cell(186,1)
        textCard= cell2.value
        
        cell2 = first_sheet.cell(187,1)
        ...
        sheet.cell(row=189, column=2).value = FirstNameUpdated
        sheet.cell(row=190, column=2).value = LastNameUpdated
        sheet.cell(row=191, column=2).value = EmailIdUpdated
        sheet.cell(row=192, column=2).value = EmployeeIdUpdated
        ...
        try:
            ...
            print "\nCreating Track"
            cr=TrackGetLinkPublishedTrackForMA()
...
if __name__ == '__main__':
    ...
    tr=TrackGetLinkPublishedTrackForMA()
    tr.TrackGetLinkPublishedForMAMain()
