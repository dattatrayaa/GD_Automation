...
class TrackWithAllCardsTwoTimes:
    ...
    def trackWithAllCardTwoTime(self):
        ...
        try:
            ...
            tri.allCardstwoTime(lessonName, textCard, Imagefilepath1, videoPath, timeToUploadVideo, documentPath, timetoUploadDoc, questionCard, ans1, ans2)
...
if __name__ == '__main__':
    ...
    ol=TrackWithAllCardsTwoTimes()
    ol.trackWithAllCardTwoTime()
