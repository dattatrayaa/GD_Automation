...
class GroupWithAttributesLocation:
    def create(self,FirstName,LastName,Email,EmployeeId,Password,location,attributeName):
    ...
    def groupCreateForCampaign(self,groupName,FirstName,attributeName,location):
        driver.refresh()
        wait=WebDriverWait(driver, 60)
        ...
        group.OverViewContainer(location)
    ...
    def CreateGroupWithAttributeLocation(self):
        ...
        sheet.cell(row=56, column=2).value = FirstNameUpdated
        sheet.cell(row=57, column=2).value = LastNameUpdated
        sheet.cell(row=58, column=2).value = EmailIdUpdated
        sheet.cell(row=59, column=2).value = EmployeeIdUpdated
        sheet.cell(row=61, column=2).value = locationIdUpdated
        sheet.cell(row=62, column=2).value = groupNameUpdated
        ...
        try:
            t=GroupWithAttributesLocation()
            print "\nCreating New User\n"
            t.create(FirstName, LastName, Email, EmployeeId, Password, location, attributeName)
            
            print "\nCreating Group with '"+location+"' Attribute\n"
            t.groupCreateForCampaign(groupName, FirstName, attributeName, location)
...
if __name__=='__main__':
    ...
    gr=GroupWithAttributesLocation()
    gr.CreateGroupWithAttributeLocation()
