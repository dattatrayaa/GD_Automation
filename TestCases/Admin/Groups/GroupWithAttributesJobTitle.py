...
class GroupWithAttributesJobTitle:
    
    def create(self,FirstName,LastName,Email,EmployeeId,Password,jobtitle,attributeName):
    ...
    def groupCreateForCampaign(self,groupName,FirstName,attributeName,jobtitle):
        driver.refresh()
        wait=WebDriverWait(driver, 60)
        ...
        group.OverViewContainer(jobtitle)
    ...
    def CreateGroupWithAttributeJobTitle(self):
        ...
        sheet.cell(row=45, column=2).value = FirstNameUpdated
        sheet.cell(row=46, column=2).value = LastNameUpdated
        sheet.cell(row=47, column=2).value = EmailIdUpdated
        sheet.cell(row=48, column=2).value = EmployeeIdUpdated
        sheet.cell(row=50, column=2).value = jobtitleIdUpdated
        sheet.cell(row=51, column=2).value = groupNameUpdated
        ...
        try:
            t=GroupWithAttributesJobTitle()
            print "\nCreating New User\n"
            t.create(FirstName, LastName, Email, EmployeeId, Password, jobtitle, attributeName)
            
            print "\nCreating Group with '"+jobtitle+"' Attribute\n"
            t.groupCreateForCampaign(groupName, FirstName, attributeName, jobtitle)
...
if __name__=='__main__':
    ...
    gr=GroupWithAttributesJobTitle()
    gr.CreateGroupWithAttributeJobTitle()
