...
class GrovoWithAttributesDepartment:
    
    def create(self,FirstName,LastName,Email,EmployeeId,Password,deptName,attributeName):
    ...
    def groupCreateForCampaign(self,groupName,FirstName,attributeName,deptName):
        driver.refresh()
        wait=WebDriverWait(driver, 60)
    ...
    def createGroupWithAttributeDepartment(self):
        ...
        sheet.cell(row=24, column=2).value = FirstNameUpdated
        sheet.cell(row=25, column=2).value = LastNameUpdated
        sheet.cell(row=26, column=2).value = EmailIdUpdated
        sheet.cell(row=27, column=2).value = EmployeeIdUpdated
        sheet.cell(row=29, column=2).value = deptNameIdUpdated
        sheet.cell(row=30, column=2).value = groupNameUpdated
        ...
        try:
            t=GrovoWithAttributesDepartment()
            print "\nCreating New User\n"
            t.create(FirstName, LastName, Email, EmployeeId, Password, deptName, attributeName)
            
            print "\nCreating Group with '"+deptName+"' Attribute\n"
            t.groupCreateForCampaign(groupName, FirstName, attributeName, deptName)
...
if __name__=='__main__':
    ...
    gr=GrovoWithAttributesDepartment()
    gr.CreateGroupWithAttributeDepartment()
