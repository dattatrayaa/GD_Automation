...
class RoleLearnAdministratorUserContentRoleTagBrand():
    
    def createLearnAdministratorUserContentRoleTagBrandRole(self,RoleName,Description):
    ...
    def createLearnAdministratorUserContentRoleTagBrandMain(self):
        from BaseTestClass import excelPath  
         try:   
            ...
            obj2= RoleLearnAdministratorUserContentRoleTagBrand()
            obj2.createLearnAdministratorUserContentRoleTagBrandRole(RoleName,Description)  
...
if __name__ == '__main__':
    ...
    obj11= LearnAdministratorUserContentRoleTagBrand()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createLearnAdministratorUserContentRoleTagBrandMain()