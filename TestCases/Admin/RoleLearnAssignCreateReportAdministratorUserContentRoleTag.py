...
class RoleLearnAssignCreateReportAdministratorUserContentRoleTag():
    def createLearnAssignCreateReportAdministratorUserContentRoleTag(self,RoleName,Description):
    ...
    def createLearnAssignCreateReportAdministratorUserContentRoleTagMain(self): 
        from BaseTestClass import projectPath 
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(420,1)
            RoleName = cell.value
            cell = sheet.cell(421,1)
            Description = cell.value
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            first_sheet = book.sheet_by_name('UserAssignToRole')
            cell = first_sheet.cell(3,1)
            FirstName = cell.value
            obj2= RoleLearnAssignCreateReportAdministratorUserContentRoleTag()
            obj2.createLearnAssignCreateReportAdministratorUserContentRoleTag(RoleName,Description)
...
if __name__ == '__main__':
    ...
    obj11= LearnAssignCreateReportAdministratorUserContentRoleTag()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createLearnAssignCreateReportAdministratorUserContentRoleTagMain()