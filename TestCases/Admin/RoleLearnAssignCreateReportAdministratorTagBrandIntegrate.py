...
class RoleLearnAssignCreateReportAdministratorTagBrandIntegrate():
    
    def createLearnAssignCreateReportAdministratorTagBrandIntegrate(self,RoleName,Description):
    ...
    def createLearnAssignCreateReportAdministratorTagBrandIntegrateMain(self): 
        from BaseTestClass import excelPath 
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(432,1)
            RoleName = cell.value
            cell = sheet.cell(433,1)
            Description = cell.value
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            first_sheet = book.sheet_by_name('UserAssignToRole')
            cell = first_sheet.cell(3,1)
            FirstName = cell.value
            obj2= RoleLearnAssignCreateReportAdministratorTagBrandIntegrate()
            obj2.createLearnAssignCreateReportAdministratorTagBrandIntegrate(RoleName,Description)  
...
if __name__ == '__main__':
    ...
    obj11= LearnAssignCreateReportAdministratorTagBrandIntegrate()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createLearnAssignCreateReportAdministratorTagBrandIntegrateMain()