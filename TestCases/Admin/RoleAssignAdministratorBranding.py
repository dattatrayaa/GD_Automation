...
class RoleAssignAdministratorBranding():
    def createAssignAdministratorBranding(self,RoleName,Description):
    ...
    def createAssignAdministratorBrandingMain(self):  
        ...
        try:   
            ...
            obj2= RoleAssignAdministratorBranding()
            obj2.createAssignAdministratorBranding(RoleName,Description)  
...
if __name__ == '__main__':
    ...
    obj11= AssignAdministratorBranding()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createAssignAdministratorBrandingMain()