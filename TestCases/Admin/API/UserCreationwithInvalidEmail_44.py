...
class UserCreationwithInvalidEmail_44:
    
    def userCreationwithInvalidEmail(self):
    ...
    def UserCreationwithInvalidEmailId(self):
        try:
            obj=UserCreationwithInvalidEmail_44()
            obj.userCreationwithInvalidEmail()
            obj.againuserLogin() 
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= UserCreationwithInvalidEmail_44()
    obj1.userCreationwithInvalidEmail()
    obj1.againuserLogin()
