...
class BasicInformationInvalidKeyAttriRole_30:
    
    def userCreationWithInvalidKeyAttriRole(self):
    ...
    def BasicInformationInvalidKeyAttriRole(self):
        try:
            obj=BasicInformationInvalidKeyAttriRole_30()
            obj.userCreationWithInvalidKeyAttriRole()
            obj.againuserLogin() 
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= BasicInformationInvalidKeyAttriRole_30()
    obj1.userCreationWithInvalidKeyAttriRole()
    obj1.againuserLogin()
