...
class APIBasicInformationWithoutKeyAttriRole:
    
    def userCreationWithoutKeyAttriRole(self):
    ...
    def BasicInformationInvalidKeyAttriRole(self):
        try:
            obj=APIBasicInformationWithoutKeyAttriRole()
            obj.userCreationWithoutKeyAttriRole()
            obj.againuserLogin() 
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= APIBasicInformationWithoutKeyAttriRole()
    obj1.userCreationWithoutKeyAttriRole()
    obj1.againuserLogin()
