...
class APIDirectRoleMasterAdmin:
    
    def directRoleMasterAdmin(self):
    ...
    def Logincreateuser(self):    
        ...
        book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
        sheet1=book.sheet_by_name('API testing')
        cell2 = sheet1.cell(14,2)
        Currentpassword = cell2.value
        cell3 = sheet1.cell(14,3)
    ...
    def DirectRoleAsMasterAdmin(self):
        try:
            obj=APIDirectRoleMasterAdmin()  
            obj.directRoleMasterAdmin()
            obj.Logincreateuser()
            obj.againuserLogin()
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= APIDirectRoleMasterAdmin()
    obj1.directRoleMasterAdmin()
