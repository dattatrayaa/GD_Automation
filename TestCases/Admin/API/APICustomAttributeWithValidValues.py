...
class APICustomAttributeWithValidValues:
    
    def customAttributeWithValidData(self):
    ...
    def AdditionalAttributeWithValidDatas(self):
        try:
            obj=APICustomAttributeWithValidValues()  
            obj.customAttributeWithValidData()
            obj.Logincreateuser()
            obj.againuserLogin()
