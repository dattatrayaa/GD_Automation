...
class APIUserCreationWithInvalidEmpId:
    
    def userCreationWithInvalidEmpId(self):
    ...
    def Logincreateuser(self):    
        ...
        book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
        sheet1=book.sheet_by_name('API testing')
        cell2 = sheet1.cell(15,2)
        Currentpassword = cell2.value
        cell3 = sheet1.cell(15,3)
    ...
    def UserCreationWithInvalidEmployeeId(self):
        try:
            obj=APIUserCreationWithInvalidEmpId()
            obj.userCreationWithInvalidEmpId()
            obj.Logincreateuser()
            obj.againuserLogin() 
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= APIUserCreationWithInvalidEmpId()
    obj1.userCreationWithInvalidEmpId()
