...
class AdditionalAttributeWithInvalidValues_50:
    ...
    def Logincreateuser(self):    
        ...
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        sheet1=book.sheet_by_name('API testing')
        cell2 = sheet1.cell(8,2)
        Currentpassword = cell2.value
        cell3 = sheet1.cell(8,3)
    ...
    def AdditionalAttributeWithInvalidValue(self):
        try:
            obj=AdditionalAttributeWithInvalidValues_50()  
            obj.additionalAttributeWithInvalidValues()
            obj.Logincreateuser()
            obj.againuserLogin()
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= AdditionalAttributeWithInvalidValues_50()
    obj1.additionalAttributeWithInvalidValues() 
