...
class APIUserCreationWithBlankHireDate:
    
    def userCreationWithBlankHireDate(self):
    ...
    def UserCreateWithBlankHireDate(self):
        try:
            obj=APIUserCreationWithBlankHireDate()
            obj.userCreationWithBlankHireDate()
            obj.againuserLogin() 
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= APIUserCreationWithBlankHireDate()
    obj1.userCreationWithBlankHireDate()
    obj1.againuserLogin()
