...
class BasicInformationInvalidAttributesRole_34:
    ...
    def BasicInformationInvalidKeyAttriRole(self):
        try:
            obj=BasicInformationInvalidAttributesRole_34()
            obj.userCreationWithInvalidAttributesRole()
            obj.againuserLogin() 
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= BasicInformationInvalidAttributesRole_34()
