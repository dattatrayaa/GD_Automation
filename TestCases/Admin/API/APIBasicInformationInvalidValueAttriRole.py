...
class APIBasicInformationInvalidValueAttriRole:
    
    def userCreationWithInvalidValueAttriRole(self):
    ...
    def BasicInformationInvalidKeyAttriRole(self):
        try:
            obj=APIBasicInformationInvalidValueAttriRole()
            obj.userCreationWithInvalidValueAttriRole()
            obj.againuserLogin() 
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= APIBasicInformationInvalidValueAttriRole()
    obj1.userCreationWithInvalidValueAttriRole()
    obj1.againuserLogin()
