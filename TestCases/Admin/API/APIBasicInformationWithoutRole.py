...
class APIBasicInformationWithoutRole:
    
    def userCreationWithoutRole(self):
    ...
    #def Logincreateuser(self):    
        ...
        #sheet1=book.sheet_by_name('API testing')
        #cell2 = sheet1.cell(12,2)
        #Currentpassword = cell2.value
        #cell3 = sheet1.cell(12,3)
    ...
    def BasicInformationwithoutrole(self):
        try:
            obj=APIBasicInformationWithoutRole()
            obj.userCreationWithoutRole()
            #obj.Logincreateuser()
            obj.againuserLogin() 
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= APIBasicInformationWithoutRole()
    obj1.userCreationWithoutRole()
