...
class AdditionalAttributeWithValidData_48:
    
    def additionalAttributeWithValidData(self):
        ...
        if not country:
            ...
            print"Country is present : "+country 
        ...
        if not department:
            ...
            print"Department is present : "+department    
        ...
        if not job:
            ...
            print"Job Title is present : "+job     
        ...
        if not location:
            ...
            print"Location is present : "+location 
        ...
        if not region:
            ...
            print"Region is present : "+region
            
        #To verify Reports To field 
        print"Verify ReportsTo field"
        reportlocator =driver.find_element_by_xpath("html/body/div/div/div[3]/div[2]/div/div[3]/div/div/div[4]/div[2]/div/div/div[2]/div/span[1]/div[1]/span")
        report=reportlocator.text
        if not report:
            print"ReportsTo field is empty"
        else:
            print"ReportsTo is present : "+report    
    ...
    def Logincreateuser(self):    
        ...
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        sheet1=book.sheet_by_name('API testing')
        cell2 = sheet1.cell(6,2)
        Currentpassword = cell2.value
        cell3 = sheet1.cell(6,3)
    ...
    def AdditionalAttributeWithValidDatas(self):
        try:
            obj=AdditionalAttributeWithValidData_48()  
            obj.additionalAttributeWithValidData()
            obj.Logincreateuser()
            obj.againuserLogin()
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= AdditionalAttributeWithValidData_48()
    obj1.additionalAttributeWithValidData() 
