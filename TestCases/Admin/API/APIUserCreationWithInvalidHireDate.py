...
class APIUserCreationWithInvalidHireDate:
    
    def userCreationWithInvalidHireDate(self):
    ...
    def UserCreationWithInvalidAsHireDate(self):
        try:
            obj=APIUserCreationWithInvalidHireDate()
            obj.userCreationWithInvalidHireDate()
            obj.againuserLogin() 
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= APIUserCreationWithInvalidHireDate()
    obj1.userCreationWithInvalidHireDate()
    obj1.againuserLogin()
