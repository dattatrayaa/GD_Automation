...
class UserCreationAlreadyExistingEmail_37:
    
    def userCreationAlreadyExistingEmail(self):
    ...
    def userCreationAlreadyExistingPrimaryEmail(self):
        try:
            obj=UserCreationAlreadyExistingEmail_37()
            obj.userCreationAlreadyExistingEmail()
            obj.againuserLogin() 
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= UserCreationAlreadyExistingEmail_37()
    obj1.userCreationAlreadyExistingEmail()
    obj1.againuserLogin()
