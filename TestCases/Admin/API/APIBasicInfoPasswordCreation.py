...
class APIBasicInfoPasswordCreation:
    ...
    def testPasswordCreationForUser(self):
        ...
        wait.until(EC.visibility_of_element_located((By.XPATH,".//*[@id='content']/div/div[3]/div[2]/div/div/div[4]/table/tbody/tr[2]/td[1]/a")))
    ...
    def BasicInfoPasswordCreation(self):
        try:
            obj=APIBasicInfoPasswordCreation()
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= APIBasicInfoPasswordCreation()
    obj1.testPasswordCreationForUser()
