...
class RoleReportAdministratorUserContentTagBrandIntegrate():
    
    def createReportAdministratorUserContentTagBrandIntegrate(self,RoleName,Description):
    ...
    def createReportAdministratorUserContentTagBrandIntegrateMain(self):  
        try:   
            ...
            obj2= RoleReportAdministratorUserContentTagBrandIntegrate()
            obj2.createReportAdministratorUserContentTagBrandIntegrate(RoleName,Description)  
...
if __name__ == '__main__':
    ...
    obj11= ReportAdministratorUserContentTagBrandIntegrate()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createReportAdministratorUserContentTagBrandIntegrateMain()