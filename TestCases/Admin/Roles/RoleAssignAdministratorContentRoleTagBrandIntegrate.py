...
class RoleAssignAdministratorContentRoleTagBrandIntegrate():
    
    def createAssignAdministratorContentRoleTagBrandIntegrate(self,RoleName,Description):
    ...
    def createAssignAdministratorContentRoleTagBrandIntegrateMain(self):  
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(316,1)
            RoleName = cell.value
            cell = sheet.cell(317,1)
            ...
            obj2= RoleAssignAdministratorContentRoleTagBrandIntegrate()
            obj2.createAssignAdministratorContentRoleTagBrandIntegrate(RoleName,Description)
...
if __name__ == '__main__':
    ...
    obj11= AssignAdministratorContentRoleTagBrandIntegrate()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createAssignAdministratorContentRoleTagBrandIntegrateMain()