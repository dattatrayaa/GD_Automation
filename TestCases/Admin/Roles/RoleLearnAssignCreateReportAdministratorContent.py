...
class RoleLearnAssignCreateReportAdministratorContent():
    
    def createLearnAssignCreateReportAdministratorContent(self,RoleName,Description):
    ...
    def createLearnAssignCreateReportAdministratorContentMain(self):  
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(464,5)
            RoleName = cell.value
            cell = sheet.cell(465,5)
            Description = cell.value
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            first_sheet = book.sheet_by_name('UserAssignToRole')
            cell = first_sheet.cell(3,1)
            FirstName = cell.value 
            obj2= RoleLearnAssignCreateReportAdministratorContent()
            obj2.createLearnAssignCreateReportAdministratorContent(RoleName,Description) 
...
if __name__ == '__main__':
    ...
    obj11= LearnAssignCreateReportAdministratorContent()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createLearnAssignCreateReportAdministratorContentMain()