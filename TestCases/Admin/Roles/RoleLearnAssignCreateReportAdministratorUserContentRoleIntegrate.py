...
class RoleLearnAssignCreateReportAdministratorUserContentRoleIntegrate():
    
    def createLearnAssignCreateReportAdministratorUserContentRoleIntegrate(self,RoleName,Description):
    ...
    def createLearnAssignCreateReportAdministratorUserContentRoleIntegrateMain(self):  
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(456,5)
            RoleName = cell.value
            cell = sheet.cell(457,5)
            Description = cell.value
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            first_sheet = book.sheet_by_name('UserAssignToRole')
            cell = first_sheet.cell(3,1)
            FirstName = cell.value
            obj2= RoleLearnAssignCreateReportAdministratorUserContentRoleIntegrate()
            obj2.createLearnAssignCreateReportAdministratorUserContentRoleIntegrate(RoleName,Description)  
...
if __name__ == '__main__':
    ...
    obj11= LearnAssignCreateReportAdministratorUserContentRoleIntegrate()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createLearnAssignCreateReportAdministratorUserContentRoleIntegrateMain()