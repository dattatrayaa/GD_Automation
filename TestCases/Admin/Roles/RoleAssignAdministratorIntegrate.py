...
class RoleAssignAdministratorIntegrate():
    
    def createAssignAdministratorIntegrate(self,RoleName,Description):
    ...
    def createAssignAdministratorIntegrateMain(self):  
        try:   
            ...
            obj2= RoleAssignAdministratorIntegrate()
            obj2.createAssignAdministratorIntegrate(RoleName,Description)
