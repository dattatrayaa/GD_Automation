...
class RoleLearnAssignCreateReportAdministratorUserContentRoleTagBrand():
    def createLearnAssignCreateReportAdministratorUserContentRoleTagBrand(self,RoleName,Description):
    ...
    def createLearnAssignCreateReportAdministratorUserContentRoleTagBrandMain(self): 
        from BaseTestClass import excelPath 
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(416,5)
            RoleName = cell.value
            cell = sheet.cell(417,5)
            Description = cell.value
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            first_sheet = book.sheet_by_name('UserAssignToRole')
            cell = first_sheet.cell(3,1)
            FirstName = cell.value
            obj2= RoleLearnAssignCreateReportAdministratorUserContentRoleTagBrand()
            obj2.createLearnAssignCreateReportAdministratorUserContentRoleTagBrand(RoleName,Description) 
...
if __name__ == '__main__':
    ...
    obj11= LearnAssignCreateReportAdministratorUserContentRoleTagBrand()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createLearnAssignCreateReportAdministratorUserContentRoleTagBrandMain()