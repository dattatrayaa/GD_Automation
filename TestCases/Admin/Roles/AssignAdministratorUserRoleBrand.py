...
class AssignAdministratorUserRoleBrand():
    
    def createAssignAdministratorUserRoleBrand(self,RoleName,Description):
    ...
    def createAssignAdministratorUserRoleBrandMain(self):  
        try:   
            ...
            cell = sheet.cell(340,5)
            RoleName = cell.value
            cell = sheet.cell(341,5)
            ...
            obj2= AssignAdministratorUserRoleBrand()
            obj2.createAssignAdministratorUserRoleBrand(RoleName,Description)
...
if __name__ == '__main__':
    ...
    obj11= AssignAdministratorUserRoleBrand()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createAssignAdministratorUserRoleBrandMain()