...
class RoleReportAdministratorUser():
    
    def createReportAdministratorUser(self,RoleName,Description):
    ...
    def createReportAdministratorUserMain(self):  
        ...
        try:   
            ...
            obj2= RoleReportAdministratorUser()
            obj2.createReportAdministratorUser(RoleName,Description)  
...
if __name__ == '__main__':
    ...
    obj11= ReportAdministratorUser()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createReportAdministratorUserMain()