...
class ReportRole():
    ...
    def createReportRole(self,RoleName,Description):
    ...
    def reportRoleMain(self): 
        ...
        try:   
            ...
            obj2= ReportRole()
            obj2.createReportRole(RoleName,Description)  
