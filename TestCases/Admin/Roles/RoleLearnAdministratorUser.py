...
class RoleLearnAdministratorUser():
...
if __name__ == '__main__':
    ...
    obj11= LearnAdministratorUser()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createLearnAdministratorUserMain()