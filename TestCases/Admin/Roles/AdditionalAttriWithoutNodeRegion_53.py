...
class AdditionalAttriWithoutNodeRegion_53:
...
#             regionlocator.text             
    ...
    def AdditionalAttriWithoutNodeRegionvalue(self):
        try:
            obj=AdditionalAttriWithoutNodeRegion_53()  
            obj.AdditionalAttriWithoutNodeRegion()
            obj.Logincreateuser()
            obj.againuserLogin()
