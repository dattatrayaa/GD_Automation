...
class RoleReportAdministratorUserContent():
    
    def createReportAdministratorUserContent(self,RoleName,Description):
    ...
    def createReportAdministratorUserContentMain(self):
        ...
        try:   
            ...
            RoleName = cell.value
            cell = sheet.cell(369,5)
            Description = cell.value
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            first_sheet = book.sheet_by_name('UserAssignToRole')
            cell = first_sheet.cell(2,1)
            FirstName = cell.value
            obj2= RoleReportAdministratorUserContent()
            obj2.createReportAdministratorUserContent(RoleName,Description)  
...
if __name__ == '__main__':
    ...
    obj11= ReportAdministratorUserContent()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createReportAdministratorUserContentMain()