...
class AssignAdministratorUserTagBrandIntegrate():
    ...
    def createAssignAdministratorUserTagBrandIntegrateMain(self):  
        try:   
            ...
            cell = sheet.cell(348,5)
            RoleName = cell.value
            cell = sheet.cell(349,5)
            Description = cell.value
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            first_sheet = book.sheet_by_name('UserAssignToRole')
            cell = first_sheet.cell(1,1)
            FirstName = cell.value
            obj2= AssignAdministratorUserTagBrandIntegrate()
            obj2.createAssignAdministratorUserTagBrandIntegrate(RoleName,Description)
...
if __name__ == '__main__':
    ...
    obj11= AssignAdministratorUserTagBrandIntegrate()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createAssignAdministratorUserTagBrandIntegrateMain()