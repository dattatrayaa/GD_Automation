...
class RoleLearnAssignCreateReportAdministratorContentRoleTagBrandIntegrate():
    
    def createLearnAssignCreateReportAdministratorContentRoleTagBrandIntegrate(self,RoleName,Description):
    ...
    def createLearnAssignCreateReportAdministratorContentRoleTagBrandIntegrateMain(self):  
        ...
        try:   
            ...
            cell = sheet.cell(428,1)
            RoleName = cell.value
            cell = sheet.cell(429,1)
            Description = cell.value
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            first_sheet = book.sheet_by_name('UserAssignToRole')
            cell = first_sheet.cell(3,1)
            FirstName = cell.value
            obj2= RoleLearnAssignCreateReportAdministratorContentRoleTagBrandIntegrate()
            obj2.createLearnAssignCreateReportAdministratorContentRoleTagBrandIntegrate(RoleName,Description)  
...
if __name__ == '__main__':
    ...
    obj11= LearnAssignCreateReportAdministratorContentRoleTagBrandIntegrate()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createLearnAssignCreateReportAdministratorContentRoleTagBrandIntegrateMain()