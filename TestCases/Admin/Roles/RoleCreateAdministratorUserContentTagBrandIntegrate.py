...
class RoleCreateAdministratorUserContentTagBrandIntegrate():
    
    def createCreateAdministratorUserContentTagBrandIntegrate(self,RoleName,Description):
    ...
    def createCreateAdministratorUserContentTagBrandIntegrateMain(self):  
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(279,1)
            RoleName = cell.value
            cell = sheet.cell(280,1)
            Description = cell.value
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            first_sheet = book.sheet_by_name('UserAssignToRole')
            cell = first_sheet.cell(4,1)
            FirstName = cell.value
            obj2= RoleCreateAdministratorUserContentTagBrandIntegrate()
            obj2.createCreateAdministratorUserContentTagBrandIntegrate(RoleName,Description)
...
if __name__ == '__main__':
    ...
    obj11= CreateAdministratorUserContentTagBrandIntegrate()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createCreateAdministratorUserContentTagBrandIntegrateMain()