...
class RoleAssignAdministratorRoleTag():
    
    def createAssignAdministratorRoleTag(self,RoleName,Description):
    ...
    def maincreateAssignAdministratorRoleTag(self):
        from BaseTestClass import excelPath  
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(328,5)
            RoleName = cell.value
            cell = sheet.cell(329,5)
            ...
            obj2= RoleAssignAdministratorRoleTag()
            obj2.createAssignAdministratorRoleTag(RoleName,Description)
...
if __name__ == '__main__':
    ...
    obj11= AssignAdministratorRoleTag()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createAssignAdministratorRoleTagMain()