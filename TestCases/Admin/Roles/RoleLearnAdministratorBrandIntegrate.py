...
class RoleLearnAdministratorBrandIntegrate():
    ...
    def createLearnAdministratorBrandIntegrate(self,RoleName,Description):
    ...
    def createLearnAdministratorBrandIntegrateMain(self):  
        try:   
            ...
            obj2= RoleLearnAdministratorBrandIntegrate()
            obj2.createLearnAdministratorBrandIntegrate(RoleName,Description) 
...
if __name__ == '__main__':
    ...
    obj11= LearnAdministratorBrandIntegrate()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createLearnAdministratorBrandIntegrateMain()