...
class RoleLearnAssignCreateReportAdministratorUserRole():
    
    def createLearnAssignCreateReportAdministratorUserRole(self,RoleName,Description):
    ...
    def createLearnAssignCreateReportAdministratorUserRoleMain(self):  
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(468,1)
            RoleName = cell.value
            cell = sheet.cell(469,1)
            Description = cell.value
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            first_sheet = book.sheet_by_name('UserAssignToRole')
            cell = first_sheet.cell(3,1)
            FirstName = cell.value
            obj2= RoleLearnAssignCreateReportAdministratorUserRole()
            obj2.createLearnAssignCreateReportAdministratorUserRole(RoleName,Description)  
...
if __name__ == '__main__':
    ...
    obj11= LearnAssignCreateReportAdministratorUserRole()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createLearnAssignCreateReportAdministratorUserRoleMain()