...
class CreateUserBlankFMLN_46:
    
    def createUserBlankFMLN(self):
    ...
    def CreateUserWithBlankFMLN(self):
        try:
            obj=CreateUserBlankFMLN_46()
            obj.createUserBlankFMLN()
            obj.againuserLogin() 
