...
class RoleReportAdministratorContentTagBrandIntegrate():
    
    def createReportAdministratorContentTagBrandIntegrate(self,RoleName,Description):
    ...
    def createReportAdministratorContentTagBrandIntegrateMain(self): 
        from BaseTestClass import excelPath 
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(416,1)
            RoleName = cell.value
            cell = sheet.cell(416,1)
            ...
            obj2= RoleReportAdministratorContentTagBrandIntegrate()
            obj2.createReportAdministratorContentTagBrandIntegrate(RoleName,Description)  
...
if __name__ == '__main__':
    ...
    obj11= ReportAdministratorContentTagBrandIntegrate()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createReportAdministratorContentTagBrandIntegrateMain()