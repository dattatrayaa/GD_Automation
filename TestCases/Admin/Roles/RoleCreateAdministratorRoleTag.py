...
class RoleCreateAdministratorRoleTag():
    
    def createCreateAdministratorRoleTag(self,RoleName,Description):
    ...
    def mainCrteAdminRoleTag(self):
        ...
        try:   
            ...
            obj2= RoleCreateAdministratorRoleTag()
            obj2.createCreateAdministratorRoleTag(RoleName,Description)
...
if __name__ == '__main__':
    ...
    obj11= CreateAdministratorRoleTag()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.mainCrteAdminRoleTag()