...
class UserUpdationWithExistingEmp_38:
    
    def userUpdationWithExistingEmp(self):
        ...
        wait.until(EC.visibility_of_element_located((By.XPATH,".//*[@id='content']/div/div[3]/div[2]/div/div/div[4]/table/tbody/tr/td[2]/a")))
        driver.find_element_by_xpath(".//*[@id='content']/div/div[3]/div[2]/div/div/div[4]/table/tbody/tr/td[2]/a").click()
        ...
        if not firstName:
            ...
            print"FirstName is updated with :" +firstName
        ...
        if not lastName:
            ...
            print"LastName is updated with : "+lastName
        ...
        if not email:
            ...
            print"Email is updated with : "+email
    ...
    def Logincreateuser(self):    
        ...
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        sheet1=book.sheet_by_name('API testing')
        cell2 = sheet1.cell(16,2)
        Currentpassword = cell2.value
        cell3 = sheet1.cell(16,3)
    ...
    def UserUpdationWithExistingEmpId(self):
        try:
            obj=UserUpdationWithExistingEmp_38()
            obj.userUpdationWithExistingEmp()
            obj.Logincreateuser()
            obj.againuserLogin() 
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= UserUpdationWithExistingEmp_38()
