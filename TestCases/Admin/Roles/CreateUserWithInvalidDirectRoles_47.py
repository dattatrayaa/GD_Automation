...
class CreateUserWithInvalidDirectRoles_47:
    
    def createUserWithInvalidDirectRoles(self):
    ...
    def CreateUserWithInvalidValueDirectRoles(self):
        try:
            obj=CreateUserWithInvalidDirectRoles_47()
            obj.createUserWithInvalidDirectRoles()
            obj.againuserLogin() 
...
if __name__ == '__main__':
    ob= BaseTestClass()
    ob.UserLogin()
    obj1= CreateUserWithInvalidDirectRoles_47()
