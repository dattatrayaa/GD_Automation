...
class RoleCreateRole():
    
    def createCreateRole(self,RoleName,Description):
    ...
    def createRoleMain(self):
        ...
        try:   
            ...
            obj2= RoleCreateRole()
            obj2.createCreateRole(RoleName,Description)  
