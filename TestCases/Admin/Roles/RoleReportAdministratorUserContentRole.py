...
class RoleReportAdministratorUserContentRole():
    
    def createReportAdministratorUserContentRole(self,RoleName,Description):
    ...
    def createReportAdministratorUserContentRoleMain(self):  
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(368,1)
            RoleName = cell.value
            cell = sheet.cell(368,1)
            ...
            obj2= RoleReportAdministratorUserContentRole()
            obj2.createReportAdministratorUserContentRole(RoleName,Description)  
...
if __name__ == '__main__':
    ...
    obj11= ReportAdministratorUserContentRole()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createReportAdministratorUserContentRoleMain()