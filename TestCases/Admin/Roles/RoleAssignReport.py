...
class RoleAssignReport():
    
    def createAssignReportRole(self,RoleName,Description):
    ...
    def createAssignReportMain(self):
        ...
        try:   
            ...
            obj2= RoleAssignReport()
            obj2.createAssignReportRole(RoleName,Description)
