...
class RoleLearnAssignCreateReportAdministratorUserTagBrandIntegrate():
    
    def createLearnAssignCreateReportAdministratorUserTagBrandIntegrate(self,RoleName,Description):
    ...
    def createLearnAssignCreateReportAdministratorUserTagBrandIntegrateMain(self):  
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(460,1)
            RoleName = cell.value
            cell = sheet.cell(461,1)
...
if __name__ == '__main__':
    ...
    obj11= LearnAssignCreateReportAdministratorUserTagBrandIntegrate()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createLearnAssignCreateReportAdministratorUserTagBrandIntegrateMain()