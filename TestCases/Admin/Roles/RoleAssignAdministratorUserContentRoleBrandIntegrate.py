...
class RoleAssignAdministratorUserContentRoleBrandIntegrate():
    
    def createAssignAdministratorUserContentRoleBrandIntegrate(self,RoleName,Description):
    ...
    def createAssignAdministratorUserContentRoleBrandIntegrateMain(self):
        from BaseTestClass import excelPath  
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(340,1)
            RoleName = cell.value
            cell = sheet.cell(341,1)
            Description = cell.value
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            first_sheet = book.sheet_by_name('UserAssignToRole')
            cell = first_sheet.cell(1,1)
            FirstName = cell.value
            obj2= RoleAssignAdministratorUserContentRoleBrandIntegrate()
            obj2.createAssignAdministratorUserContentRoleBrandIntegrate(RoleName,Description)
...
if __name__ == '__main__':
    ...
    obj11= AssignAdministratorUserContentRoleBrandIntegrate()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createAssignAdministratorUserContentRoleBrandIntegrateMain()