...
class RoleAssignAdministratorContentTagIntegrate():
    
    def createAssignAdministratorContentTagIntegrate(self,RoleName,Description):
    ...
    def createAssignAdministratorContentTagIntegrateMain(self):  
        try:   
            book=xlrd.open_workbook(os.path.join('Test_Data/TestData.xlsx'))
            sheet=book.sheet_by_name('Role')
            cell = sheet.cell(344,1)
            RoleName = cell.value
            cell = sheet.cell(345,1)
            ...
            obj2= RoleAssignAdministratorContentTagIntegrate()
            obj2.createAssignAdministratorContentTagIntegrate(RoleName,Description)
...
if __name__ == '__main__':
    ...
    obj11= AssignAdministratorContentTagIntegrate()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createAssignAdministratorContentTagIntegrateMain()