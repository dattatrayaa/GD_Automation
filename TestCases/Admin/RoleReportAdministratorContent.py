...
class RoleReportAdministratorContent():
    ...
    def createReportAdministratorContentMain(self): 
        ...
        try:   
            ...
            obj2= RoleReportAdministratorContent()
            obj2.createReportAdministratorContent(RoleName,Description)  
...
if __name__ == '__main__':
    ...
    obj11= ReportAdministratorContent()
    obj12= BaseTestClass()
    obj12.UserLogin()
    obj11.createReportAdministratorContentMain()