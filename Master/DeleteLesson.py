    ...
    def lessonDelete(self,lessonname):  
        try:                                                       
            ...
            for count in range (0,count):
                ...
                wait.until(EC.visibility_of_element_located((By.XPATH,"html/body/div[4 or 2]/div/div/div[2]/div[2]/button[.='Delete']")))
                wait.until(EC.element_to_be_clickable((By.XPATH,"html/body/div[4 or 2]/div/div/div[2]/div[2]/button[.='Delete']")))
                delo = driver.find_element_by_xpath("html/body/div[4 or 2]/div/div/div[2]/div[2]/button[.='Delete']")
                webdriver.ActionChains(driver).move_to_element(delo).click(delo).perform()
                #driver.execute_script('arguments[0].click()',delo)
                #print "Deleted"
                wait.until(EC.invisibility_of_element_located((By.XPATH,"html/body/div[4 or 2]/div/div/div[1]/button")))
                driver.refresh()
        finally:
